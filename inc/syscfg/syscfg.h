...
#define MYNEWT_VAL_BLE_SM_OUR_KEY_DIST (BLE_SM_PAIR_KEY_DIST_ENC | BLE_SM_PAIR_KEY_DIST_ID | BLE_SM_PAIR_KEY_DIST_SIGN)
#endif
...
#define MYNEWT_VAL_BLE_SM_THEIR_KEY_DIST (BLE_SM_PAIR_KEY_DIST_ENC)
#endif
